...
namespace KH.DAL
{
	...
	public partial class LearnCardsDAL
	{
		...
		public bool Exists(long Id)
		{
			...
			strSql.Append("select count(1) from T_LearnCards");
		...
		/// 增加一条数据
		/// </summary>
		public long Add(KH.Model.LearnCards model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_LearnCards(");
			strSql.Append("CourseId,CardNum,ExpireDays,Password,UserId,ActiveDateTime)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(KH.Model.LearnCards model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_LearnCards set ");
		...
		public bool Delete(long Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_LearnCards ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public KH.Model.LearnCards GetModel(long Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,CourseId,CardNum,ExpireDays,Password,UserId,ActiveDateTime from T_LearnCards ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)
			};
			...
			KH.Model.LearnCards model=new KH.Model.LearnCards();
		...
		/// 得到一个对象实体
		/// </summary>
		public KH.Model.LearnCards DataRowToModel(DataRow row)
		{
			KH.Model.LearnCards model=new KH.Model.LearnCards();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,CourseId,CardNum,ExpireDays,Password,UserId,ActiveDateTime ");
			strSql.Append(" FROM T_LearnCards ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,CourseId,CardNum,ExpireDays,Password,UserId,ActiveDateTime ");
			strSql.Append(" FROM T_LearnCards ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_LearnCards T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "T_LearnCards";
